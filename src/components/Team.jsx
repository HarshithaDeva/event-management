...
class Team extends React.Component{
    ...
    <div class="col-lg-4">
          ...
          <img class="bd-placeholder-img rounded-circle" width="160" height="160" xmlns="http://www.w3.org/2000/svg" src={mani} alt="" role="img"  preserveAspectRatio="xMidYMid slice" focusable="false"/><title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em"></text>
          <h2>K.MANI KUMARI</h2>
          <p>LOGISTICS MANAGER</p>
          <p><a class="btn btn-info" href="/#">View details &raquo;</a></p>
    </div>
